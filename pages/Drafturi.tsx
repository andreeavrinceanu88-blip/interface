                            ...
                            <div className="space-y-6 pb-10">
                                ...
                                <div className="grid grid-cols-5 gap-4">
                                    <div className="col-span-4 flex flex-wrap gap-3">
                                        <button onClick={() => callClient(selectedOrder.phone_number)} className="px-5 flex items-center justify-center gap-1.5 btn-3d-primary py-2 rounded-xl transition-all shadow-[0_2px_8px_rgba(34,197,94,0.15)] text-sm font-medium shrink-0">
                                        ...
                                        >
                                            <svg viewBox="0 0 24 24" fill="#25D366" className="w-4 h-4 shrink-0" xmlns="http://www.w3.org/2000/svg">
