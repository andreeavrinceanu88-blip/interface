                            ...
                            <div className="space-y-6 pb-10">
                                ...
                                <div className="grid grid-cols-5 gap-6">
                                    <div className="col-span-3 flex gap-4">
                                        <button onClick={() => callClient(selectedOrder.phone_number)} className="px-6 flex items-center justify-center gap-1.5 btn-3d-primary py-2 rounded-full transition-all shadow-[0_2px_8px_rgba(34,197,94,0.15)] text-sm font-medium shrink-0">
                                        ...
                                        >
                                            <svg viewBox="0 0 24 24" fill="#25D366" className="w-5 h-5 shrink-0" xmlns="http://www.w3.org/2000/svg">
                                                        ...
                                                        try {
                                                            ...
                                                            try {
                                                                ...
                                                                if (result && result.errorMsg) { // we will return errorMsg from service
                                                                    ...
                                                                    showShopifyNotif(`Shopify sincronizat ✓ Lista a fost actualizată! (Metoda 1.5s REST)\nS-a trimis transport: ${finalShippingPriceForShopify}`, 'success');
                                                                } else {
                                                                    showShopifyNotif(`Eroare Shopify — ${apiErrorMsg}`, 'error');
                                                                }
                                                            } catch (e: any) {
